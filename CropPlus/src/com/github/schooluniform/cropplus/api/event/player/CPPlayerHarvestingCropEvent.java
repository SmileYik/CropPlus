...
/**
 * Triggered when harvesting crops <p> 
 * \u6536\u83b7\u4f5c\u7269\u65f6\u89e6\u53d1
...
public class CPPlayerHarvestingCropEvent extends CropPlusPlayerEvent{
	...
	public CPPlayerHarvestingCropEvent(Player player,String cropId,LinkedList<ItemStack> drops,Location location) {
	 ...
	 * Get drop items. <p>
	 * \u83b7\u53d6\u6389\u843d\u7269
	 * @return A LinkedList of drop items. <p>
	 * \u5305\u542b\u6389\u843d\u7269\u7684LinkedList
	 */
